...
echo "    3. Run: /deploy-orchestration"
echo "       This will:"
echo "       - Discover and install task-specific skills"
echo "       - Generate CLAUDE.md orchestration section"
if [ "$PROJECT_TYPE" = "multi" ]; then
echo "       - Set up sub-project structure in src/"
fi
echo ""
